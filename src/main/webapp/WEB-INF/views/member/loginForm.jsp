...
<head>
    ...
    <style>
        ...
        .card-3d-wrap {
            ...
            perspective: 800px;
            /*margin-top: 60px;*/
            margin-top: calc(50vh - 200px); /* 화면의 중앙에 위치 */
            display: flex;
                                        ...
                                        <div class="section text-center">
                                            ...
                                            <form action="" method="post">
                                                <div class="form-group">
                                                    <input type="text" name="customerId" class="form-style" placeholder="Your Id" id="logemail" autocomplete="off">
