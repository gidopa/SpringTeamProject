            ...
            <div class="card-body">
                ...
                <form method="POST" action enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <input class="input--style-2" type="text" placeholder="Attraction_Name" name="attractionName" value="${attraction.attractionName}" required>
                    </div>
                    ...
                    <!-- 명소 설명 -->
                    <div class="input-group">
                        <input class="input--style-2" type="text" placeholder="Attraction_Description" name="attractionDescription" value="${attraction.attractionDescription}" required>
                    </div>
